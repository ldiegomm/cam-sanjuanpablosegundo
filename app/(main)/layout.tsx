    ...
    <div className={styles.app}>
      <div className={styles.sidebar}>
        ...
        <nav className={styles.nav}>
          ...
          {isAdmin && (
            <button type="button" className={`${styles.navItem} ${pathname.startsWith('/notificaciones') ? styles.navItemActive : ''}`} onClick={() => handleRouteClick('/notificaciones')} aria-current={pathname.startsWith('/notificaciones') ? 'page' : undefined}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
